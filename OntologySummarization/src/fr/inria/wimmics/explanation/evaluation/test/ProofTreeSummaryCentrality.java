...
public class ProofTreeSummaryCentrality {
	...
	public void treeSummarizedStatementsInf2() throws Exception {
		...
		Map<Double,Measures> resInf2 = computeMeasures("rdf/inference2-just.trig", rootNodes.get(1), humanEntriesInf2, fullSize.get(1));
		printMeasures(resInf2);			
	}
	@Test
	public void treeSummarizedStatementsInf3() throws Exception {
		System.out.println("Inference 3");
		Map<Double,Measures> resInf3 = computeMeasures("rdf/inference3-just.trig", rootNodes.get(2), humanEntriesInf3, fullSize.get(2));
