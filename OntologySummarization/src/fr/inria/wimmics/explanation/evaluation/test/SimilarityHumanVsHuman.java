...
import fr.inria.wimmics.explanation.evaluation.test.RankingCorrelationHumanVsHuman.MyStrCmp;
import fr.inria.wimmics.util.Util;

public class SimilarityHumanVsHuman {
	...
	public void Inference1Degree() throws Exception {
		...
		//humanDegreeInf1.put("Similarity-Algo","files/evaluation/inf1/inf1-degree.txt");
		humanDegreeInf1.put("Similarity-Alan","files/evaluation/inf1/inf1-sim-alan.txt");
		humanDegreeInf1.put("Similarity-Franck","files/evaluation/inf1/inf1-sim-franck.txt");
		humanDegreeInf1.put("Similarity-Gessica","files/evaluation/inf1/inf1-sim-gessica.txt");
		humanDegreeInf1.put("Similarity-Julien","files/evaluation/inf1/inf1-sim-julien.txt");
		...
		for(int i=0;i<humanDegreeEntriesInf1.size();i++) {
			...
			System.out.println(humanDegreeEntriesInf1.get(i).getKey()+": "+Util.round(pAgreement));
	...
	public void Inference2Degree() throws Exception {
		//############################### Inference 2 ##########################################
		//humanDegreeInf1.put("Similarity-Algo","files/evaluation/inf1/inf1-degree.txt");
		humanDegreeInf2.put("Similarity-Alan","files/evaluation/inf2/inf2-sim-alan.txt");
		humanDegreeInf2.put("Similarity-Franck","files/evaluation/inf2/inf2-sim-franck.txt");
		humanDegreeInf2.put("Similarity-Gessica","files/evaluation/inf2/inf2-sim-gessica.txt");
		humanDegreeInf2.put("Similarity-Julien","files/evaluation/inf2/inf2-sim-julien.txt");
		...
		for(int i=0;i<humanDegreeEntriesInf2.size();i++) {
			...
			System.out.println(humanDegreeEntriesInf2.get(i).getKey()+": "+Util.round(pAgreement));
	...
	public void Inference3Degree() throws Exception {
		//############################### Inference 2 ##########################################
		//humanDegreeInf1.put("Similarity-Algo","files/evaluation/inf1/inf1-degree.txt");
		humanDegreeInf3.put("Similarity-Alan","files/evaluation/inf3/inf3-sim-alan.txt");
		humanDegreeInf3.put("Similarity-Franck","files/evaluation/inf3/inf3-sim-franck.txt");
		humanDegreeInf3.put("Similarity-Gessica","files/evaluation/inf3/inf3-sim-gessica.txt");
		humanDegreeInf3.put("Similarity-Julien","files/evaluation/inf3/inf3-sim-julien.txt");
		...
		for(int i=0;i<humanDegreeEntries.size();i++) {
			...
			double pAgreement = pSum/pCount;
			pSumSumIn2 += pAgreement;
			System.out.println(humanDegreeEntries.get(i).getKey()+": "+Util.round(pAgreement));
		...
		//System.out.println("Human agreement Inference 3: "+Util.round(humanDegreeCountSumIn2/humanDegreeCountIn2));
		System.out.println("Human agreement avg Inference 3: "+Util.round(pSumSumIn2/humanDegreeEntries.size()));
